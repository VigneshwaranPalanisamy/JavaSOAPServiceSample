package conversion.service.client;
...
import conversion.service.ca.javajeff.uc.UC;
...
public class UCClient
{
   public static void main(String[] args) throws Exception
   {
      ...
      QName qname = new QName("http://uc.javajeff.ca.service.conversion/",
                              "UCImplService");
      Service service = Service.create(url, qname);
      qname = new QName("http://uc.javajeff.ca.service.conversion/", "UCImplPort");
      UC uc = service.getPort(qname, UC.class);
      //UC uc = service.getPort(UC.class);
      System.out.printf("DC to DF: 37 DC = %f DF%n", uc.c2fa());
